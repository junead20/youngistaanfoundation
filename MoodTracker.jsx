    ...
    <div className="page" style={{ paddingTop: '10vh' }}>
      <div className="animate-fade-up" style={{ textAlign: 'center', width: '100%', maxWidth: 600 }}>
        ...
        <div style={{ marginBottom: 40 }}>
          <p style={{ fontSize: 13, color: 'var(--text-muted)', marginBottom: 16 }}>v Anything specific? (optional)</p>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
          <button 
            ...
            style={{ width: '100%', maxWidth: 400, opacity: selectedMood ? 1 : 0.5, padding: '16px 0', fontSize: 18, borderRadius: 100, background: 'linear-gradient(135deg, #E9D5FF, #D8B4FE)', color: '#6B21A8', boxShadow: 'none' }}
