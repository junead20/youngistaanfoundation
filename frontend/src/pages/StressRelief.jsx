...
const STAGES = [
  { name: 'Inhale', duration: 4, color: '#A78BFA' },
  { name: 'Hold', duration: 4, color: '#06B6D4' },
  { name: 'Exhale', duration: 4, color: '#EC4899' },
    ...
    <div className="app-layout">
      ...
      <main className="main-content">
        ...
        <div className="glass" style={{ marginTop: 40, padding: 32, display: 'flex', gap: 24, alignItems: 'flex-start' }}>
           <div style={{ width: 44, height: 44, borderRadius: 12, background: 'rgba(6,182,212,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
