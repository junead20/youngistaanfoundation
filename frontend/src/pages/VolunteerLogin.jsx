      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
        <div className="glass animate-fade-up" style={{ width: '100%', maxWidth: isRegistering ? 600 : 400, padding: 40 }}>
          <div style={{ textAlign: 'center', marginBottom: 32 }}>
            <div style={{ display: 'inline-flex', padding: 12, borderRadius: 16, background: 'rgba(209,242,255,0.3)', marginBottom: 16 }}>
              <ShieldCheck size={32} color="#7ABCD4" />
            </div>
          ...
          {error && (
            <div style={{ padding: '12px 16px', borderRadius: 10, background: 'rgba(255,224,224,0.3)', border: '1px solid rgba(255,224,224,0.5)', color: '#B85C5C', fontSize: 13, marginBottom: 24 }}>
              {error}
            </div>
          )}
