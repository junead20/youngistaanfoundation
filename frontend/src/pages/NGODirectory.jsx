  ...
  return (
    <div className="app-layout">
      ...
      <main className="main-content">
            ...
            <div key={i} className="glass animate-fade-up" style={{ padding: 24, transition: 'transform 0.2s' }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 16 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                   <div style={{ width: 44, height: 44, borderRadius: 12, background: ngo.isHelpline ? 'rgba(239,68,68,0.1)' : 'rgba(6,182,212,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      {ngo.isHelpline ? <Phone size={20} color="#EF4444" /> : <Building2 size={20} color="#06B6D4" />}
                   </div>
                   <div>
        ...
        <div className="glass" style={{ padding: 24, textAlign: 'center', background: 'rgba(59,130,246,0.05)', border: '1px solid rgba(59,130,246,0.1)' }}>
            <Heart size={24} color="#3B82F6" style={{ marginBottom: 12 }} />
