...
const EMOTIONS = [
  { emoji: '😊', label: 'Happy', value: 'Happy', color: '#a8e6cf' },
  { emoji: '😐', label: 'Neutral', value: 'Neutral', color: '#ffe5a0' },
  { emoji: '😔', label: 'Sad', value: 'Sad', color: '#d1f2ff' },
  { emoji: '😣', label: 'Stressed', value: 'Stressed', color: '#ffe0e0' }
];
    ...
    <div className="app-layout">
      ...
      <main className="main-content">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 28 }}>
          <div>
            <h1 className="section-title"><Heart size={22} style={{ display: 'inline', marginRight: 10, color: '#ffc6e9' }} />Mood Tracker</h1>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: 32 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 12 }}>
                  ...
                  <span style={{ fontWeight: 700, color: form.stressLevel > 6 ? '#B85C5C' : '#5cb89c' }}>{form.stressLevel}</span>
                </div>
                <input 
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                {entries.map(e => {
                  ...
                  const color = e.stressLevel <= 3 ? '#5cb89c' : e.stressLevel <= 6 ? '#C4A43D' : '#B85C5C';
                  return (
