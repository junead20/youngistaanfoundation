  ...
  return (
    <div className="pre-login-container">
      <div className="glass-card pre-login-card animate-fade-up" style={{ textAlign: 'center', padding: '48px 32px' }}>
        ...
        {/* Brand Icon */}
        <div style={{ display: 'inline-flex', padding: 20, borderRadius: 24, background: 'linear-gradient(135deg, rgba(124,58,237,0.1), rgba(6,182,212,0.1))', border: '1px solid rgba(124,58,237,0.2)', marginBottom: 28 }} className="animate-float">
          <Brain size={48} className="gradient-text-purple" />
        </div>

        <h1 style={{ fontSize: 32, fontWeight: 900, marginBottom: 12, letterSpacing: '-0.5px' }}>
          Welcome to <span className="gradient-text">MindBridge</span>
        </h1>
